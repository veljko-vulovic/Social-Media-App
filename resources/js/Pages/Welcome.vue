            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    ...
                    >
                        <div>
                            <div
                                class="flex justify-center items-center w-16 h-16 bg-red-50 rounded-full dark:bg-red-800/20"
                            >
                                <svg
                                    fill="none"
                                    viewBox="0 0 24 24"
                        ...
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            stroke-width="1.5"
                            class="self-center mx-6 w-6 h-6 shrink-0 stroke-red-500"
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <div class="flex gap-4 items-center">
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                                class="-mt-px w-5 h-5 me-1 stroke-gray-400 dark:stroke-gray-600 group-hover:stroke-gray-600 dark:group-hover:stroke-gray-400"
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
